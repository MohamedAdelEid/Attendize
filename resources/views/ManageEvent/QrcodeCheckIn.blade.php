...
<body>
  <div id="main">
    <header id="header">
      <h2 class="text-center"><span style="font-size: 1.2em; font-weight: 600;">Four Links</span><br><span style="font-size: 0.7em;">@lang("ManageEvent.check-in"): <strong>{{ $event->title }}</strong></span></h2>
    </header>
