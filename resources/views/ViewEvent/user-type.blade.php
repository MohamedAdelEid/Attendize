...
<main class="min-h-screen">
        ...
        <div class="container mx-auto px-4 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="{{ route('showEventSymposium', ['event_id' => $event->id]) }}" class="flex items-center gap-4">
                    <img src="{{ asset('images/sgss-logo.png') }}" alt="الجمعية السعودية للجراحة العامة - SGSS" class="bg-white h-12 w-12 md:h-14 md:w-14 object-contain" onerror="this.style.display='none'">
    ...
    {{-- Mobile menu --}}
    <div id="mobile-menu" class="md:hidden hidden" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; min-height: 100vh; z-index: 9999;">
