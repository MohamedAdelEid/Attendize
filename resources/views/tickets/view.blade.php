    ...
    <div class="overflow-hidden bg-white shadow-lg rounded-xl">
        <div class="p-6 md:p-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('downloadTicket', ['token' => $user->ticket_token]) }}" class="inline-flex items-center px-4 py-2 text-white transition-colors rounded-md bg-primary-600 hover:bg-primary-700">
